...
interface CryptoWeb3AnimationProps {
  className?: string;
}

const CryptoWeb3Animation = ({ className = '' }: CryptoWeb3AnimationProps) => {
  return (
    <>
      <Box
        component="svg"
		...
		<g>
			...
			<line fill="none" stroke="#4DFF6B" stroke-width="3.4927" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10"
      ...
      <g id="d-appswrapper">
        <g id="d-app">
					...
					<g>
						...
						<linearGradient id="SVGID_9_" gradientUnits="userSpaceOnUse" x1="596.3016" y1="1506.1545" x2="524.3275" y2="1464.6003" gradientTransform="matrix(1 0 0 -1 0 1900)">
							<stop offset="0" style="stop-color:#1DA630" />
							<stop offset="0.2302" style="stop-color:#20AA33" />
							<stop offset="0.4367" style="stop-color:#29B43A" />
							<stop offset="0.634" style="stop-color:#38C748" />
							<stop offset="0.8245" style="stop-color:#4DE05A" />
							<stop offset="1" style="stop-color:#66FF70" />
						</linearGradient>
					...
					l47.6-28.3c0,0,2.3-1.4,2.5-3.4C612.8,416.2,612.7,416.3,612.3,414.1z" />
						...
						<linearGradient id="SVGID_10_" gradientUnits="userSpaceOnUse" x1="536.1385" y1="1511.8278" x2="577.0161" y2="1453.4487" gradientTransform="matrix(1 0 0 -1 0 1900)">
							<stop offset="0" style="stop-color:#45E65C" />
							<stop offset="1" style="stop-color:#3DFF49" />
						</linearGradient>
				...
				c0,3.4,0.3,5,3.6,6.7l46.4,27.5c0,0,7.1,4,14.6,0.1l47.6-28.6C609.8,406.9,612.7,405.4,612.2,401.4z" />
					<g>
						<circle fill="#80FF88" cx="553.5" cy="364.8" r="1.5" />
						<circle fill="#80FF88" cx="518.5" cy="307.8" r="0.5" />
						<circle fill="#FFFFFF" cx="600.2" cy="379.4" r="0.7" />
						<circle fill="#29C480" cx="581.8" cy="310.5" r="0.7" />
						...
						<circle fill="#80FF88" cx="576.7" cy="339.6" r="0.7" />
						...
						<circle fill="#29C480" cx="604.2" cy="357.9" r="1.4" />
						<circle fill="#FFFFFF" cx="521.8" cy="341" r="0.7" />
						<circle fill="#29C480" cx="506.9" cy="322" r="0.7" />
						<circle fill="#29C480" cx="513" cy="361.5" r="0.7" />
						<circle fill="#29C480" cx="554.8" cy="313.4" r="1" />
						<circle fill="#29C480" cx="539.3" cy="341.7" r="1.4" />
        ...
        <g id="d-apps2">
				...
				<g>
					...
					<g>
						<circle fill="#80FF88" cx="1249.2" cy="825.7" r="1.5" />
						<circle fill="#80FF88" cx="1214.2" cy="768.7" r="0.5" />
						<circle fill="#FFFFFF" cx="1295.9" cy="840.3" r="0.7" />
						<circle fill="#29C480" cx="1277.5" cy="771.4" r="0.7" />
						...
						<circle fill="#80FF88" cx="1272.4" cy="800.5" r="0.7" />
						...
						<circle fill="#29C480" cx="1300" cy="818.8" r="1.4" />
						<circle fill="#FFFFFF" cx="1217.5" cy="801.9" r="0.7" />
						<circle fill="#29C480" cx="1202.6" cy="782.9" r="0.7" />
						<circle fill="#29C480" cx="1208.8" cy="822.4" r="0.7" />
						<circle fill="#29C480" cx="1250.5" cy="774.3" r="1" />
						<circle fill="#29C480" cx="1235.1" cy="802.6" r="1.4" />
...
RK5CYII=" transform="matrix(0.98 0 0 0.98 590.2817 497.2417)">
		...
		555.6,608.9 		" enable-background="new    " opacity="0.25" />
				<linearGradient id="SVGID_42_" x1="1042.4587" x2="993.0236" y1="-985.6109" y2="-790.8901" gradientTransform="matrix(0.3592 -0.3065 1.2019 0.6834 1339.3929 1550.1232)"
				    gradientUnits="userSpaceOnUse">
					<stop offset="0" style="stop-color:#FFFFFF;stop-opacity:0" />
					<stop offset="0.2113" style="stop-color:#D7FFDA;stop-opacity:0.2113" />
					<stop offset="0.4448" style="stop-color:#B1FFB8;stop-opacity:0.4448" />
					<stop offset="0.6617" style="stop-color:#96FF9F;stop-opacity:0.6617" />
					<stop offset="0.8535" style="stop-color:#86FF90;stop-opacity:0.8535" />
					<stop offset="1" style="stop-color:#80FF8B" />
				</linearGradient>
		...
		492.7,577.2 		" enable-background="new    " opacity="0.35" />
			...
			<g id="greenblocksparticles">
				<g>
					<linearGradient id="SVGID_91_" x1="3650.8601" x2="3659.948" y1="114.5993" y2="168.2118" gradientTransform="matrix(-0.3592 -0.3065 -1.2019 0.6834 2623.3687 1550.1232)"
					    gradientUnits="userSpaceOnUse">
						<stop offset="0" style="stop-color:#B3FFB7;stop-opacity:0" />
						<stop offset="1" style="stop-color:#B3FFB7" />
					</linearGradient>
			...
			1141.3,409 			" enable-background="new    " />
					<g>
						<circle cx="1115.2" cy="508.7" r="1.5" fill="#80FF88" />
						<circle cx="1080.2" cy="451.7" r="0.5" fill="#80FF88" />
						<circle cx="1161.9" cy="523.3" r="0.7" fill="#FFFFFF" />
						<circle cx="1143.5" cy="454.4" r="0.7" fill="#29C480" />
						...
						<circle cx="1138.4" cy="483.5" r="0.7" fill="#80FF88" />
						...
						<circle cx="1166" cy="501.8" r="1.4" fill="#29C480" />
						<circle cx="1083.5" cy="484.9" r="0.7" fill="#FFFFFF" />
						<circle cx="1068.6" cy="465.9" r="0.7" fill="#29C480" />
						<circle cx="1074.8" cy="505.4" r="0.7" fill="#29C480" />
						<circle cx="1116.5" cy="457.3" r="1" fill="#29C480" />
						<circle cx="1101.1" cy="485.6" r="1.4" fill="#29C480" />
				...
				<g>
					...
					<polygon fill="url(#SVGID_94_)" points="734.3,649.1 797,690 888,638.6 825.3,597 
						" enable-background="new    " opacity="0.35" />
					<g>
						<circle cx="799.2" cy="696.7" r="1.5" fill="#80FF88" />
						<circle cx="764.2" cy="639.7" r="0.5" fill="#80FF88" />
						<circle cx="845.9" cy="711.3" r="0.7" fill="#FFFFFF" />
						<circle cx="827.5" cy="642.4" r="0.7" fill="#29C480" />
						...
						<circle cx="822.4" cy="671.5" r="0.7" fill="#80FF88" />
						...
						<circle cx="850" cy="689.8" r="1.4" fill="#29C480" />
						<circle cx="767.5" cy="672.9" r="0.7" fill="#FFFFFF" />
						<circle cx="752.6" cy="653.9" r="0.7" fill="#29C480" />
						<circle cx="758.8" cy="693.4" r="0.7" fill="#29C480" />
						<circle cx="800.5" cy="645.3" r="1" fill="#29C480" />
						<circle cx="785.1" cy="673.6" r="1.4" fill="#29C480" />
				...
				<g>
					...
					<polygon fill="url(#SVGID_96_)" points="575.3,742.1 638,783 729,731.6 666.3,690 
						" enable-background="new    " opacity="0.35" />
					<g>
						<circle cx="640.2" cy="789.7" r="1.5" fill="#80FF88" />
						<circle cx="605.2" cy="732.7" r="0.5" fill="#80FF88" />
						<circle cx="686.9" cy="804.3" r="0.7" fill="#FFFFFF" />
						<circle cx="668.5" cy="735.4" r="0.7" fill="#29C480" />
						...
						<circle cx="663.4" cy="764.5" r="0.7" fill="#80FF88" />
						...
						<circle cx="691" cy="782.8" r="1.4" fill="#29C480" />
						<circle cx="608.5" cy="765.9" r="0.7" fill="#FFFFFF" />
						<circle cx="593.6" cy="746.9" r="0.7" fill="#29C480" />
						<circle cx="599.8" cy="786.4" r="0.7" fill="#29C480" />
						<circle cx="641.5" cy="738.3" r="1" fill="#29C480" />
						<circle cx="626.1" cy="766.6" r="1.4" fill="#29C480" />
				...
				<g>
					...
					<polygon fill="url(#SVGID_98_)" points="420.3,835.1 483,876 574,824.6 511.3,783 
						" enable-background="new    " opacity="0.35" />
					<g>
						<circle cx="485.2" cy="882.7" r="1.5" fill="#80FF88" />
						<circle cx="450.2" cy="825.7" r="0.5" fill="#80FF88" />
						<circle cx="531.9" cy="897.3" r="0.7" fill="#FFFFFF" />
						<circle cx="513.5" cy="828.4" r="0.7" fill="#29C480" />
						...
						<circle cx="508.4" cy="857.5" r="0.7" fill="#80FF88" />
						...
						<circle cx="536" cy="875.8" r="1.4" fill="#29C480" />
						<circle cx="453.5" cy="858.9" r="0.7" fill="#FFFFFF" />
						<circle cx="438.6" cy="839.9" r="0.7" fill="#29C480" />
						<circle cx="444.8" cy="879.4" r="0.7" fill="#29C480" />
						<circle cx="486.5" cy="831.3" r="1" fill="#29C480" />
						<circle cx="471.1" cy="859.6" r="1.4" fill="#29C480" />
		...
		l-0.8-1.3L1524.4,178.1z" />
			...
			<g id="firstBlock">
				<linearGradient id="SVGID_49_" x1="1299.6068" x2="1361.6029" y1="-311.3163" y2="-344.4973" gradientTransform="matrix(1 0 0 1 0 700)"
				    gradientUnits="userSpaceOnUse">
					<stop offset="0" style="stop-color:#1BA937" />
					<stop offset="0.2857" style="stop-color:#1FB237" />
					<stop offset="0.75" style="stop-color:#2BCA38" />
					<stop offset="1" style="stop-color:#32DA39" />
				</linearGradient>
				...
				<linearGradient id="SVGID_50_" x1="1372.5" x2="1424.6" y1="-353.6" y2="-301.5" gradientTransform="matrix(1 0 0 1 0 700)"
				    gradientUnits="userSpaceOnUse">
					<stop offset="0" style="stop-color:#99FF9F" />
					<stop offset="0.1701" style="stop-color:#7BF285" />
					<stop offset="0.4158" style="stop-color:#55E366" />
					<stop offset="0.6441" style="stop-color:#3AD74F" />
					<stop offset="0.8458" style="stop-color:#2AD041" />
					<stop offset="1" style="stop-color:#24CE3C" />
				</linearGradient>
				...
				<linearGradient id="SVGID_51_" x1="1347.0559" x2="1388.1415" y1="-355.8673" y2="-420.1857" gradientTransform="matrix(1 0 0 1 0 700)"
				    gradientUnits="userSpaceOnUse">
					<stop offset="0" style="stop-color:#29C480" />
					<stop offset="5.850000e-02" style="stop-color:#45E450" />
					<stop offset="0.6415" style="stop-color:#2DD441" />
					<stop offset="1" style="stop-color:#24CE3C" />
				</linearGradient>
				...
				<linearGradient id="SVGID_52_" x1="1390.3" x2="1404.4501" y1="-371.4" y2="-357.25" gradientTransform="matrix(1 0 0 1 0 700)"
				    gradientUnits="userSpaceOnUse">
					<stop offset="0" style="stop-color:#FFFFFF" />
					<stop offset="0.2713" style="stop-color:#C8FDB0" />
					<stop offset="0.5184" style="stop-color:#9CFB83" />
					<stop offset="0.7299" style="stop-color:#7CF95B" />
					<stop offset="0.8974" style="stop-color:#68F843" />
					<stop offset="1" style="stop-color:#61F83A" />
				</linearGradient>
...
CzAAqYTVOPWO2yYAAAAASUVORK5CYII=" transform="matrix(0.98 0 0 0.98 1024.2817 776.2417)">
			...
			955,672.8 		" />
				...
				<linearGradient id="SVGID_148_" gradientUnits="userSpaceOnUse" x1="763.4714" y1="1027.7656" x2="725.6356" y2="878.7339" gradientTransform="matrix(0.3592 -0.3065 -1.2019 -0.6834 1880.408 1551.1382)">
					<stop offset="0" style="stop-color:#80FF8B" />
					<stop offset="0.3874" style="stop-color:#B2FFB9;stop-opacity:0.5873" />
	...
	` }}
      ...
      {/* CSS Animations from dist/style.css */}
      <style jsx global>{`
        html {
  background: #0C0019;
}
...
#greenblocksparticles g:nth-child(1) polygon {
  opacity: 0.35;
  -webkit-animation: glow 4s 1s ease infinite;
          animation: glow 4s 1s ease infinite;
}

#greenblocksparticles g:nth-child(2) polygon {
  opacity: 0.35;
  -webkit-animation: glow 4s 1s ease infinite;
          animation: glow 4s 1s ease infinite;
}

#greenblocksparticles g:nth-child(3) polygon {
  opacity: 0.35;
  -webkit-animation: glow 4s 1s ease infinite;
          animation: glow 4s 1s ease infinite;
}

#greenblocksparticles g:nth-child(4) polygon {
  opacity: 0.35;
  -webkit-animation: glow 4s 1s ease infinite;
          animation: glow 4s 1s ease infinite;
}

#greenblocksparticles g:nth-child(1) g circle:nth-child(1) {
  -webkit-animation: dots 4s 1050ms ease infinite;
          animation: dots 4s 1050ms ease infinite;
}

#greenblocksparticles g:nth-child(2) g circle:nth-child(1) {
  -webkit-animation: dots 4s 1050ms ease infinite;
          animation: dots 4s 1050ms ease infinite;
}

#greenblocksparticles g:nth-child(3) g circle:nth-child(1) {
  -webkit-animation: dots 4s 1050ms ease infinite;
          animation: dots 4s 1050ms ease infinite;
}

#greenblocksparticles g:nth-child(4) g circle:nth-child(1) {
  -webkit-animation: dots 4s 1050ms ease infinite;
          animation: dots 4s 1050ms ease infinite;
}

#greenblocksparticles g:nth-child(1) g circle:nth-child(2) {
  -webkit-animation: dots 4s 1100ms ease infinite;
          animation: dots 4s 1100ms ease infinite;
}

#greenblocksparticles g:nth-child(2) g circle:nth-child(2) {
  -webkit-animation: dots 4s 1100ms ease infinite;
          animation: dots 4s 1100ms ease infinite;
}

#greenblocksparticles g:nth-child(3) g circle:nth-child(2) {
  -webkit-animation: dots 4s 1100ms ease infinite;
          animation: dots 4s 1100ms ease infinite;
}

#greenblocksparticles g:nth-child(4) g circle:nth-child(2) {
  -webkit-animation: dots 4s 1100ms ease infinite;
          animation: dots 4s 1100ms ease infinite;
}

#greenblocksparticles g:nth-child(1) g circle:nth-child(3) {
  -webkit-animation: dots 4s 1150ms ease infinite;
          animation: dots 4s 1150ms ease infinite;
}

#greenblocksparticles g:nth-child(2) g circle:nth-child(3) {
  -webkit-animation: dots 4s 1150ms ease infinite;
          animation: dots 4s 1150ms ease infinite;
}

#greenblocksparticles g:nth-child(3) g circle:nth-child(3) {
  -webkit-animation: dots 4s 1150ms ease infinite;
          animation: dots 4s 1150ms ease infinite;
}

#greenblocksparticles g:nth-child(4) g circle:nth-child(3) {
  -webkit-animation: dots 4s 1150ms ease infinite;
          animation: dots 4s 1150ms ease infinite;
}

#greenblocksparticles g:nth-child(1) g circle:nth-child(4) {
  -webkit-animation: dots 4s 1200ms ease infinite;
          animation: dots 4s 1200ms ease infinite;
}

#greenblocksparticles g:nth-child(2) g circle:nth-child(4) {
  -webkit-animation: dots 4s 1200ms ease infinite;
          animation: dots 4s 1200ms ease infinite;
}

#greenblocksparticles g:nth-child(3) g circle:nth-child(4) {
  -webkit-animation: dots 4s 1200ms ease infinite;
          animation: dots 4s 1200ms ease infinite;
}

#greenblocksparticles g:nth-child(4) g circle:nth-child(4) {
  -webkit-animation: dots 4s 1200ms ease infinite;
          animation: dots 4s 1200ms ease infinite;
}

#greenblocksparticles g:nth-child(1) g circle:nth-child(5) {
  -webkit-animation: dots 4s 1250ms ease infinite;
          animation: dots 4s 1250ms ease infinite;
}

#greenblocksparticles g:nth-child(2) g circle:nth-child(5) {
  -webkit-animation: dots 4s 1250ms ease infinite;
          animation: dots 4s 1250ms ease infinite;
}

#greenblocksparticles g:nth-child(3) g circle:nth-child(5) {
  -webkit-animation: dots 4s 1250ms ease infinite;
          animation: dots 4s 1250ms ease infinite;
}

#greenblocksparticles g:nth-child(4) g circle:nth-child(5) {
  -webkit-animation: dots 4s 1250ms ease infinite;
          animation: dots 4s 1250ms ease infinite;
}

#greenblocksparticles g:nth-child(1) g circle:nth-child(6) {
  -webkit-animation: dots 4s 1300ms ease infinite;
          animation: dots 4s 1300ms ease infinite;
}

#greenblocksparticles g:nth-child(2) g circle:nth-child(6) {
  -webkit-animation: dots 4s 1300ms ease infinite;
          animation: dots 4s 1300ms ease infinite;
}

#greenblocksparticles g:nth-child(3) g circle:nth-child(6) {
  -webkit-animation: dots 4s 1300ms ease infinite;
          animation: dots 4s 1300ms ease infinite;
}

#greenblocksparticles g:nth-child(4) g circle:nth-child(6) {
  -webkit-animation: dots 4s 1300ms ease infinite;
          animation: dots 4s 1300ms ease infinite;
}

#greenblocksparticles g:nth-child(1) g circle:nth-child(7) {
  -webkit-animation: dots 4s 1350ms ease infinite;
          animation: dots 4s 1350ms ease infinite;
}

#greenblocksparticles g:nth-child(2) g circle:nth-child(7) {
  -webkit-animation: dots 4s 1350ms ease infinite;
          animation: dots 4s 1350ms ease infinite;
}

#greenblocksparticles g:nth-child(3) g circle:nth-child(7) {
  -webkit-animation: dots 4s 1350ms ease infinite;
          animation: dots 4s 1350ms ease infinite;
}

#greenblocksparticles g:nth-child(4) g circle:nth-child(7) {
  -webkit-animation: dots 4s 1350ms ease infinite;
          animation: dots 4s 1350ms ease infinite;
}

#greenblocksparticles g:nth-child(1) g circle:nth-child(8) {
  -webkit-animation: dots 4s 1400ms ease infinite;
          animation: dots 4s 1400ms ease infinite;
}

#greenblocksparticles g:nth-child(2) g circle:nth-child(8) {
  -webkit-animation: dots 4s 1400ms ease infinite;
          animation: dots 4s 1400ms ease infinite;
}

#greenblocksparticles g:nth-child(3) g circle:nth-child(8) {
  -webkit-animation: dots 4s 1400ms ease infinite;
          animation: dots 4s 1400ms ease infinite;
}

#greenblocksparticles g:nth-child(4) g circle:nth-child(8) {
  -webkit-animation: dots 4s 1400ms ease infinite;
          animation: dots 4s 1400ms ease infinite;
}

#greenblocksparticles g:nth-child(1) g circle:nth-child(9) {
  -webkit-animation: dots 4s 1450ms ease infinite;
          animation: dots 4s 1450ms ease infinite;
}

#greenblocksparticles g:nth-child(2) g circle:nth-child(9) {
  -webkit-animation: dots 4s 1450ms ease infinite;
          animation: dots 4s 1450ms ease infinite;
}

#greenblocksparticles g:nth-child(3) g circle:nth-child(9) {
  -webkit-animation: dots 4s 1450ms ease infinite;
          animation: dots 4s 1450ms ease infinite;
}

#greenblocksparticles g:nth-child(4) g circle:nth-child(9) {
  -webkit-animation: dots 4s 1450ms ease infinite;
          animation: dots 4s 1450ms ease infinite;
}

#greenblocksparticles g:nth-child(1) g circle:nth-child(10) {
  -webkit-animation: dots 4s 1500ms ease infinite;
          animation: dots 4s 1500ms ease infinite;
}

#greenblocksparticles g:nth-child(2) g circle:nth-child(10) {
  -webkit-animation: dots 4s 1500ms ease infinite;
          animation: dots 4s 1500ms ease infinite;
}

#greenblocksparticles g:nth-child(3) g circle:nth-child(10) {
  -webkit-animation: dots 4s 1500ms ease infinite;
          animation: dots 4s 1500ms ease infinite;
}

#greenblocksparticles g:nth-child(4) g circle:nth-child(10) {
  -webkit-animation: dots 4s 1500ms ease infinite;
          animation: dots 4s 1500ms ease infinite;
}

#greenblocksparticles g:nth-child(1) g circle:nth-child(11) {
  -webkit-animation: dots 4s 1550ms ease infinite;
          animation: dots 4s 1550ms ease infinite;
}

#greenblocksparticles g:nth-child(2) g circle:nth-child(11) {
  -webkit-animation: dots 4s 1550ms ease infinite;
          animation: dots 4s 1550ms ease infinite;
}

#greenblocksparticles g:nth-child(3) g circle:nth-child(11) {
  -webkit-animation: dots 4s 1550ms ease infinite;
          animation: dots 4s 1550ms ease infinite;
}

#greenblocksparticles g:nth-child(4) g circle:nth-child(11) {
  -webkit-animation: dots 4s 1550ms ease infinite;
          animation: dots 4s 1550ms ease infinite;
}

#greenblocksparticles g:nth-child(1) g circle:nth-child(12) {
  -webkit-animation: dots 4s 1600ms ease infinite;
          animation: dots 4s 1600ms ease infinite;
}

#greenblocksparticles g:nth-child(2) g circle:nth-child(12) {
  -webkit-animation: dots 4s 1600ms ease infinite;
          animation: dots 4s 1600ms ease infinite;
}

#greenblocksparticles g:nth-child(3) g circle:nth-child(12) {
  -webkit-animation: dots 4s 1600ms ease infinite;
          animation: dots 4s 1600ms ease infinite;
}

#greenblocksparticles g:nth-child(4) g circle:nth-child(12) {
  -webkit-animation: dots 4s 1600ms ease infinite;
          animation: dots 4s 1600ms ease infinite;
}

#greenblocksparticles g:nth-child(1) g circle:nth-child(13) {
  -webkit-animation: dots 4s 1650ms ease infinite;
          animation: dots 4s 1650ms ease infinite;
}

#greenblocksparticles g:nth-child(2) g circle:nth-child(13) {
  -webkit-animation: dots 4s 1650ms ease infinite;
          animation: dots 4s 1650ms ease infinite;
}

#greenblocksparticles g:nth-child(3) g circle:nth-child(13) {
  -webkit-animation: dots 4s 1650ms ease infinite;
          animation: dots 4s 1650ms ease infinite;
}

#greenblocksparticles g:nth-child(4) g circle:nth-child(13) {
  -webkit-animation: dots 4s 1650ms ease infinite;
          animation: dots 4s 1650ms ease infinite;
}

#greenblocksparticles g:nth-child(1) g circle:nth-child(14) {
  -webkit-animation: dots 4s 1700ms ease infinite;
          animation: dots 4s 1700ms ease infinite;
}

#greenblocksparticles g:nth-child(2) g circle:nth-child(14) {
  -webkit-animation: dots 4s 1700ms ease infinite;
          animation: dots 4s 1700ms ease infinite;
}

#greenblocksparticles g:nth-child(3) g circle:nth-child(14) {
  -webkit-animation: dots 4s 1700ms ease infinite;
          animation: dots 4s 1700ms ease infinite;
}

#greenblocksparticles g:nth-child(4) g circle:nth-child(14) {
  -webkit-animation: dots 4s 1700ms ease infinite;
          animation: dots 4s 1700ms ease infinite;
}

#greenblocksparticles g:nth-child(1) g circle:nth-child(15) {
  -webkit-animation: dots 4s 1750ms ease infinite;
          animation: dots 4s 1750ms ease infinite;
}

#greenblocksparticles g:nth-child(2) g circle:nth-child(15) {
  -webkit-animation: dots 4s 1750ms ease infinite;
          animation: dots 4s 1750ms ease infinite;
}

#greenblocksparticles g:nth-child(3) g circle:nth-child(15) {
  -webkit-animation: dots 4s 1750ms ease infinite;
          animation: dots 4s 1750ms ease infinite;
}

#greenblocksparticles g:nth-child(4) g circle:nth-child(15) {
  -webkit-animation: dots 4s 1750ms ease infinite;
          animation: dots 4s 1750ms ease infinite;
}

#greenblocksparticles g:nth-child(1) g circle:nth-child(16) {
  -webkit-animation: dots 4s 1800ms ease infinite;
          animation: dots 4s 1800ms ease infinite;
}

#greenblocksparticles g:nth-child(2) g circle:nth-child(16) {
  -webkit-animation: dots 4s 1800ms ease infinite;
          animation: dots 4s 1800ms ease infinite;
}

#greenblocksparticles g:nth-child(3) g circle:nth-child(16) {
  -webkit-animation: dots 4s 1800ms ease infinite;
          animation: dots 4s 1800ms ease infinite;
}

#greenblocksparticles g:nth-child(4) g circle:nth-child(16) {
  -webkit-animation: dots 4s 1800ms ease infinite;
          animation: dots 4s 1800ms ease infinite;
}

#greenblocksparticles g:nth-child(1) g circle:nth-child(17) {
  -webkit-animation: dots 4s 1850ms ease infinite;
          animation: dots 4s 1850ms ease infinite;
}

#greenblocksparticles g:nth-child(2) g circle:nth-child(17) {
  -webkit-animation: dots 4s 1850ms ease infinite;
          animation: dots 4s 1850ms ease infinite;
}

#greenblocksparticles g:nth-child(3) g circle:nth-child(17) {
  -webkit-animation: dots 4s 1850ms ease infinite;
          animation: dots 4s 1850ms ease infinite;
}

#greenblocksparticles g:nth-child(4) g circle:nth-child(17) {
  -webkit-animation: dots 4s 1850ms ease infinite;
          animation: dots 4s 1850ms ease infinite;
}

#greenblocksparticles g:nth-child(1) g circle:nth-child(18) {
  -webkit-animation: dots 4s 1900ms ease infinite;
          animation: dots 4s 1900ms ease infinite;
}

#greenblocksparticles g:nth-child(2) g circle:nth-child(18) {
  -webkit-animation: dots 4s 1900ms ease infinite;
          animation: dots 4s 1900ms ease infinite;
}

#greenblocksparticles g:nth-child(3) g circle:nth-child(18) {
  -webkit-animation: dots 4s 1900ms ease infinite;
          animation: dots 4s 1900ms ease infinite;
}

#greenblocksparticles g:nth-child(4) g circle:nth-child(18) {
  -webkit-animation: dots 4s 1900ms ease infinite;
          animation: dots 4s 1900ms ease infinite;
}

#greenblocksparticles g:nth-child(1) g circle:nth-child(19) {
  -webkit-animation: dots 4s 1950ms ease infinite;
          animation: dots 4s 1950ms ease infinite;
}

#greenblocksparticles g:nth-child(2) g circle:nth-child(19) {
  -webkit-animation: dots 4s 1950ms ease infinite;
          animation: dots 4s 1950ms ease infinite;
}

#greenblocksparticles g:nth-child(3) g circle:nth-child(19) {
  -webkit-animation: dots 4s 1950ms ease infinite;
          animation: dots 4s 1950ms ease infinite;
}

#greenblocksparticles g:nth-child(4) g circle:nth-child(19) {
  -webkit-animation: dots 4s 1950ms ease infinite;
          animation: dots 4s 1950ms ease infinite;
}
...
#greenglowparticles > :nth-child(1) {
  -webkit-animation: particles 4s 300ms ease infinite alternate, p 2s ease infinite alternate;
          animation: particles 4s 300ms ease infinite alternate, p 2s ease infinite alternate;
}
...
#greenglowparticles > :nth-child(2) {
  -webkit-animation: particles 4s 600ms ease infinite alternate, p 2s ease infinite alternate;
          animation: particles 4s 600ms ease infinite alternate, p 2s ease infinite alternate;
}
...
#greenglowparticles > :nth-child(3) {
  -webkit-animation: particles 4s 900ms ease infinite alternate, p 2s ease infinite alternate;
          animation: particles 4s 900ms ease infinite alternate, p 2s ease infinite alternate;
}
...
#greenglowparticles > :nth-child(4) {
  -webkit-animation: particles 4s 1200ms ease infinite alternate, p 2s ease infinite alternate;
          animation: particles 4s 1200ms ease infinite alternate, p 2s ease infinite alternate;
}
...
#greenglowparticles > :nth-child(5) {
  -webkit-animation: particles 4s 1500ms ease infinite alternate, p 2s ease infinite alternate;
          animation: particles 4s 1500ms ease infinite alternate, p 2s ease infinite alternate;
}
...
#greenglowparticles > :nth-child(6) {
  -webkit-animation: particles 4s 1800ms ease infinite alternate, p 2s ease infinite alternate;
          animation: particles 4s 1800ms ease infinite alternate, p 2s ease infinite alternate;
}
...
#greenglowparticles > :nth-child(7) {
  -webkit-animation: particles 4s 2100ms ease infinite alternate, p 2s ease infinite alternate;
          animation: particles 4s 2100ms ease infinite alternate, p 2s ease infinite alternate;
}
...
#greenglowparticles > :nth-child(8) {
  -webkit-animation: particles 4s 2400ms ease infinite alternate, p 2s ease infinite alternate;
          animation: particles 4s 2400ms ease infinite alternate, p 2s ease infinite alternate;
}
...
#greenglowparticles > :nth-child(9) {
  -webkit-animation: particles 4s 2700ms ease infinite alternate, p 2s ease infinite alternate;
          animation: particles 4s 2700ms ease infinite alternate, p 2s ease infinite alternate;
}
...
#greenglowparticles > :nth-child(10) {
  -webkit-animation: particles 4s 3000ms ease infinite alternate, p 2s ease infinite alternate;
          animation: particles 4s 3000ms ease infinite alternate, p 2s ease infinite alternate;
}
...
#greenglowparticles > :nth-child(11) {
  -webkit-animation: particles 4s 3300ms ease infinite alternate, p 2s ease infinite alternate;
          animation: particles 4s 3300ms ease infinite alternate, p 2s ease infinite alternate;
}
...
#greenglowparticles > :nth-child(12) {
  -webkit-animation: particles 4s 3600ms ease infinite alternate, p 2s ease infinite alternate;
          animation: particles 4s 3600ms ease infinite alternate, p 2s ease infinite alternate;
}
...
export default CryptoWeb3Animation;
