...
const AdminHomeHero = ({ className = '' }: AdminHomeHeroProps) => {
  ...
  const getSubtitle = () => {
    return "Gestiona tu cuenta y productos";
  };

  const getDescription = () => {
    return "Bienvenido a tu panel de control. Desde aquí puedes gestionar tus productos, verificar tu identidad y acceder a todas las funcionalidades de tu cuenta.";
  };
